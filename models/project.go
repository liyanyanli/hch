...
type Project struct {
	...
	QuotaNum    int     `orm:"column(quota_num)" json:"quota_num"`
	QuotaSize   float64 `orm:"column(quota_size)" json:"quota_size"`
	UseNum      int     `orm:"column(use_num)" json:"use_num"`
	UseSize     float64 `orm:"column(use_size)" json:"use_size"`
}
