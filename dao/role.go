...
import (
	...
	//	"github.com/vmware/harbor/ui"
)

const (
	clairUserID   = 3
	clairUserName = "clairuser"
)
...
//@lili
/*
func IsClairUser(userIDOrUsername interface{}) (bool, error) {
	u := models.User{}
	...
	return user.UserID == clairUserID || user.Username == clairUserName, nil
}
*/
// GetRoleByID ...
