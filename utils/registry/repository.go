...
// ManifestExist ...
func (r *Repository) ManifestExist(reference string, deleteStatus bool) (digest string, exist bool, err error) {
...
func (r *Repository) DeleteTag(tag string) error {
	digest, exist, err := r.ManifestExist(tag,true)
	if err != nil {
		return err
	}
