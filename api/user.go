...
func (ua *UserAPI) Post() {
	...
	/*
		//give user read permission of project "readonly"
		err = dao.AddProjectMember(models.READONLYPROJECT, int(userID), models.GUEST)
		if err != nil {
			log.Errorf("Failed to update DB to add project user role, project id: %d, user id: %d, role id: %d", models.READONLYPROJECT, userID, models.GUEST)
...
func validate(user models.User) error {
	...
	if isIllegalLength(user.Password, 1, 20) {
